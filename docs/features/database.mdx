...
| `jsonb_plperl`                | Provides support for storing JSONB data types with Perl's PL/Perl procedural language.                                                | [Documentation](https://www.postgresql.org/docs/current/plperl.html)             |
...
| `address_standardizer_data_us`| Provides US address data for the address standardizer extension.                                                                      | [Documentation](https://postgis.net/docs/manual-2.5/Address_Standardizer.html#idp56180176)  |
