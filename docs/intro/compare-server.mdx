...
| Server Code (City, Country)  | vCPU | RAM | Disk | Backend | Has Docker | Minimum TLS |
|------------------------------|------|-----|------|---------|------------|------------|
| SGA (Singapore)              | 2    | 2   | NVME | x64     | Yes        | TLSv1.2    |
| SGN (Singapore)              | 2    | 4   | NVME | x64     | Yes        | TLSv1.2    |
| WDC (Washington DC, US)      | 4    | 8   | NVME | x64     | Yes        | TLSv1.2    |
| SGP (Singapore)              | 3    | 16  | NVME | arm64   | Yes        | TLSv1.3    |
| MNZ (Manassas, Virginia, US) | 10   | 16  | NVME | arm64   | Yes        | TLSv1.3    |
| NUE (Nuremberg, Germany)     | 6    | 8   | NVME | arm64   | Yes        | TLSv1.3    |
| OSK (Osaka, Japan)           | 1    | 6   | NVME | arm64   | No         | TLSv1.3    |
| SAO (Sao Paulo, Brazil)      | 1    | 6   | NVME | arm64   | No         | TLSv1.3    |
