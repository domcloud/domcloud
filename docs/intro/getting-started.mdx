...
This is the domain name you want to use for your website. By default, it will be using `*.domcloud.io`, which is part of a free domain name provided by us. 

Using free domain has its own limitation: The name can't be customized and it cannot have custom records. This is intented to prevents malicious use of our platform. 

:::tip

You can use custom domain to personalize your website. Read more about [Custom Domain](../features/dns.mdx). In short, custom domain doesn't requires you to subscribe our paid plan nor buying domain from us.
