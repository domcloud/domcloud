...
These are the things that we will not do:

### Scalability

Roughly saying, a system can be defined as *scalable* if it can [be scaled horizontally](https://www.mongodb.com/basics/horizontal-vs-vertical-scaling#what-is-horizontal-scaling) during peak times.

Here, We don't do that, because our servers is **monolithic** by design. Monolithic means only one machine located in one place will handle your website. It will **never** can be horizontally scaled.
