...
No matter your system requirement is, try to find a way to do it without sudo. Again, we are not giving you sudo access to cloud servers because the shared hosting nature. Our system also has been designed to follow shared hosting best practices and it's protected behind sudo. You almost can't broke our system whatever you're trying to do.
