...
Please use a proper logging mechanism such as [the standard log library](https://deno.land/std@0.204.0/log/mod.ts) then write it to a log file, or any other solution that suits you.
