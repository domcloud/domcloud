...
+ **Unrestricted Features**: The Free Plan comes with all the features of our paid plans. This includes SSH access, Git integration, and more. The CPU and RAM resources are not limited, but still shared with other users and subject to [Fair Use](./guarantees#it-will-not-be-always-tolerable) as with other paid plans.
+ **Default domain**: All websites has a default domain name in the form of `*.domcloud.io`.

:::info

During the period of "Beta" stage of this service, the Free Plan also allows you to **choose your own domain name**. Whether this will be the case in the future once it's out of beta is yet to be decided.
