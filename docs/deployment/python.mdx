...
Install other version using `python latest`, `python stable`, `python 3.10`, `node 3.10.1`, etc. To uninstall use `python off` or `python system` (the latter leaves pyenv installed).
