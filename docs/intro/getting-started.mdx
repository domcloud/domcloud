...
One particular useful tab that you'll use often is the **Manage** section. It contains links to edit your website and also credentials to access your website. Below is the screenshot of that page.
...
Tools that you can use to manage your website are detailed in [Editor Documentation](../features/editor.mdx).
