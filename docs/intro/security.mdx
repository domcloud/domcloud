...
We recently allowing users to bypass the *'No Background Services'* policy for `Pro` plan users because of our ability to [use Docker](../deployment/docker.mdx) within our service.
