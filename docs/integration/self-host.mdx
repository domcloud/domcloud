...
dnf install btop certbot clang cmake gcc-c++ git ncdu htop iftop ipset jq lsof make nano neovim rsync sendmail socat strace tar time vim wget xz zstd \
...
libmd libreport-filesystem mesa-libGL perl-{DBD-Pg,DBD-mysql,LWP-Protocol-https,macros,DateTime,Crypt-SSLeay,Text-ASCIITable,IO-Tty,XML-Simple} {langpacks,glibc-langpack}-en \
