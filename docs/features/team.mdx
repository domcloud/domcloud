...
When you give someone access to your account, they can access your account using the Teams menu di top-right navbar. Note that it is **your** account that is shared, not them. So you can not see the invited account contents.

The role access can be either **owner**, **admin** or **member**.
...
This is the role to manage everything except financial features. If you give them this role, then you also trust them to do destructive operations with your account.
...
- Perform destructive operation in deployment systems like
  ...
  - Managing or deleting databases
  - Viweing primary SSH dan database password
...
### Remove sub user SSH accounts (only if revoked from 'member' access)
