...
+ **Default domain**: All websites can use a randomized domain name in the form of `<7-random-letters>.domcloud.io`, or use custom domain if you already buy one (either buying from ours or somewhere else).
