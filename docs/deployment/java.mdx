...
To switch Java version use feature syntax like `java latest`, `java 18`, etc. Check your current dotnet version using `java --version` in SSH.
...
Java install scripts is powered by [Microsoft OpenJDK](https://learn.microsoft.com/en-us/java/openjdk/download). 
Some old Java versions (such as JDK 8) is not available and you might need to install yourself.
