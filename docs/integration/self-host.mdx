...
dnf install btop certbot clang cmake gcc-c++ git ncdu htop iftop ipset jq lsof make nano neovim rsync sendmail strace tar time vim wget xz zstd \
{libcurl,libffi,libsqlite3x,libtool-ltdl,libyaml,nettle,openldap,passenger,python,perl,readline,xmlsec1,xmlsec1-openssl}-devel \
