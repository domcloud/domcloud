...
You can also use your own domain name, but you need to configure it first. <br/> Read more about [Custom Domain](../integration/).
...
If you plan to integrate our service with GitHub, there's so much more to read about it. Read more about [GitHub integration](../integration/github).
...
If you have problem accessing the database, you need to enable the database first through the **Deploy** tab. <br/> Read more about [Configuring Databases](../features/database).
